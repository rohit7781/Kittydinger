    ...
    <s.Screen>
      ...
      <div>
        <div className="myImage"> </div>
          ...
          >
            KittyDinger may look like a cute cat on the outside but behind the cute exterior lies a fearsome fighter
          </s.TextDescription>
          <s.TextDescription
            style={
              {
...
- A maximum of 12 $KITTIES can be minted per wallet.<br></br>
